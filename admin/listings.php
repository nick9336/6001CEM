...
<section class="listings">
   ...
   <?php
      if(isset($_POST['search_box']) OR isset($_POST['search_btn'])){
         ...
         $select_listings = $conn->prepare("SELECT * FROM `property` WHERE property_title LIKE '%{$search_box}%' OR address LIKE '%{$search_box}%' ORDER BY date DESC");
   ...
   <div class="box">
      ...
      <p class="price">RM <?= $fetch_listing['price']; ?></p>
      <h3 class="name"><?= $fetch_listing['property_title']; ?></h3>
