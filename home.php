   ...
   <section class="center">
      ...
      <form action="search.php" method="post">
         ...
         <div class="box">
            ...
            <input type="text" name="h_location" required maxlength="100" placeholder="Enter location, city or neighbourhood" class="input">
         </div>
         <div class="flex">
            <div class="box">
            ...
            <div class="box">
               ...
               <select name="h_offer" class="input">
            ...
            <div class="box">
               ...
               <input type="number" name="h_min" maxlength="999999" placeholder="RM" class="input">
            </div>

            <div class="box">
               <p>Maximum Budget <span>*</span></p>
               <input type="number" name="h_max" maxlength="999999" placeholder="RM" class="input">
            </div>
         </div>
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            ...
            <?php
               if ($isOwner) {
                  // Display "Update Listing" button for the property owner
